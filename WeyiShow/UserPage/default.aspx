<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="WeyiShow.UserPage._default" %>
                ...
                <f:Region ID="Region2" Split="true" Width="200px" ShowHeader="true" Title="菜单"
                    ...
                    <Items>
                        <f:Tree runat="server" ShowBorder="false" ShowHeader="false" EnableArrows="true" EnableLines="true" ID="leftMenuTree">
                            <Nodes>
                                <f:TreeNode Text="个人中心" Expanded="true">
                                    <f:TreeNode Text="开始页面" NavigateUrl="~/hello.aspx"></f:TreeNode>
                                    <f:TreeNode Text="购物车" NavigateUrl="~/login.aspx"></f:TreeNode>
                                    <f:TreeNode Text="个人信息" NavigateUrl="~/login.aspx"></f:TreeNode>
                                    <f:TreeNode Text="订单管理" NavigateUrl="Regist.aspx"></f:TreeNode>
                                    <f:TreeNode Text="购物车" NavigateUrl="Login.aspx"></f:TreeNode>
