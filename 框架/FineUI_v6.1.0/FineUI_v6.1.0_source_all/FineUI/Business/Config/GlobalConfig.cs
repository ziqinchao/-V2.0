...
namespace FineUI
{
    ...
    public static class GlobalConfig
    {
        ...
        /// 是否启用FState验证
        /// </summary>
        public static bool GetEnableFStateValidation()
        {
            return Convert.ToBoolean(section.EnableFStateValidation);
        }
        ...
        /// 正在加载图片的数字编号
        /// </summary>
        public static int GetLoadingImageNumber()
        {
            return section.LoadingImageNumber;
        }
