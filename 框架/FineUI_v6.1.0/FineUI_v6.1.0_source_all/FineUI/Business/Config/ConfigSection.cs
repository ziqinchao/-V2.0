...
namespace FineUI
{
    ...
    public class ConfigSection : ConfigurationSection
    {
        ...
        /// 是否启用FState压缩（不支持！！）
        /// </summary>
        [ConfigurationProperty(ConfigPropertyName.ENABLEFSTATECOMPRESS, DefaultValue = ConfigPropertyValue.ENABLE_FSTATE_COMPRESS_DEFAULT)]
        ...
        /// </summary>
        [ConfigurationProperty(ConfigPropertyName.ENABLEFSTATEVALIDATION, DefaultValue = ConfigPropertyValue.ENABLE_FSTATE_VALIDATION_DEFAULT)]
        public bool EnableFStateValidation
        {
            get
            {
                return (bool)base[ConfigPropertyName.ENABLEFSTATEVALIDATION];
            }
            set
            {
                base[ConfigPropertyName.ENABLEFSTATEVALIDATION] = value;
            }
        }
        ...
        /// 正在加载图片的类型
        /// </summary>
        [ConfigurationProperty(ConfigPropertyName.LOADINGIMAGENUMBER, DefaultValue = ConfigPropertyValue.LOADING_IMAGE_NUMBER_DEFAULT)]
        public int LoadingImageNumber
        {
            get
            {
                return (int)base[ConfigPropertyName.LOADINGIMAGENUMBER];
            }
            set
            {
                base[ConfigPropertyName.LOADINGIMAGENUMBER] = value;
            }
        }
