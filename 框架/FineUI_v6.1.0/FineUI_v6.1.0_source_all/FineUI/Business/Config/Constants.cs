...
namespace FineUI
{
    ...
    internal static class ConfigPropertyName
    {
        ...
        public const string ENABLEFSTATEVALIDATION = "EnableFStateValidation";
        ...
        public const string LOADINGIMAGENUMBER = "LoadingImageNumber";
    }
    ...
    internal static class ConfigPropertyValue
    {
        ...
        public const int LOADING_IMAGE_NUMBER_DEFAULT = 1;
