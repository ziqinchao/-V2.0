...
namespace FineUI
{
    ...
    public class StyleUtil
    {
        ...
        {
            // background-position:0 3px !important，其中!important必须存在，否则hover时会消失
            return String.Format("{0}{{background: url({1}) no-repeat;background-position:0 3px !important;height:16px;}}", selector, imageUrl);
        }
