...
namespace FineUI
{
    ...
    internal class SimulateTreeHeper
    {
        ...
        private string GetNodeContentLevelPrefix(SimulateTreeNode node, int level)
        {
            ...
            {
                if (GetParentNodeByLevel(node, level).HasLittleBrother)
                {
                    return X_ELBOW_LINE;
                }
                else
        ...
        private SimulateTreeNode GetParentNodeByLevel(SimulateTreeNode node, int level)
        {
            SimulateTreeNode parentNode = node;
