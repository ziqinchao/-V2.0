...
namespace FineUI
{
    internal static class CommonResourceHelper
    {
        ...
        internal static void RegisterCommonResource(Page page)
        {
            ...
            {
                AddContentToHead(page, CONTROL_ID_PREFIX + "xua", String.Format(META_TEMPLATE, "X-UA-Compatible", "IE=edge"));
            }
            ...
            {
                string customThemeName = PageManager.Instance.CustomTheme;

                AddCssPathToHead(page, CONTROL_ID_PREFIX + customThemeName + ".css", String.Format("{0}/ext-theme-{1}/all.css?v{2}", page.ResolveUrl(PageManager.Instance.CustomThemeBasePath), customThemeName, GlobalConfig.ProductVersion));
            }
            else
            {
                AddCssPathToHead(page, CONTROL_ID_PREFIX + themeName + "-all_1.css", String.Format("{0}/res/ext-theme-{1}/theme-{1}-all_1.css?v{2}", extjsBasePath, themeName, GlobalConfig.ProductVersion));
                AddCssPathToHead(page, CONTROL_ID_PREFIX + themeName + "-all_2.css", String.Format("{0}/res/ext-theme-{1}/theme-{1}-all_2.css?v{2}", extjsBasePath, themeName, GlobalConfig.ProductVersion));

                AddCssPathToHead(page, CONTROL_ID_PREFIX + themeName + ".css", String.Format("{0}/res/theme-{1}.css?v{2}", extjsBasePath, themeName, GlobalConfig.ProductVersion));
            }
            ...
            AddJavascriptPathToPageBottom(page, "ext-fineui.js", String.Format("{0}/ext-fineui.js?v{1}", extjsBasePath, GlobalConfig.ProductVersion));
            ...
            {
                AddJavascriptPathToPageBottom(page, "ext-theme-" + themeName + ".js", String.Format("{0}/res/ext-theme-{2}/theme-{2}.js?v{1}", extjsBasePath, GlobalConfig.ProductVersion, themeName));
            }
